...
teachers. With _Fundamentals of Software Architecture_, they have managed to
...
_—Nathaniel Schutta, Architect as a Service, ntschutta.io_
...
_—Rebecca J. Parsons, CTO, ThoughtWorks_
...
_—Cassie Shum, Technical Director, ThoughtWorks_


# **Fundamentals of Software** **Architecture**
###### **_An Engineering Approach_**

_**Mark Richards and Neal Ford**_
...
well, _softer_ than mathematics: fundamental things continue to change at a rapid pace,
...
_dynamic_ behavior over the long term. A great modern example of the nature of this
ecosystem follows the ascension of containerization and the attendant changes: tools
[like Kubernetes didn’t exist a decade ago, yet now entire software conferences exist to](https://kubernetes.io)
...
[bilities. Starting with the engineering practices of Extreme Programming, continuing](http://www.extremeprogramming.org)
...
_change_ is a first-class design consideration.
...
to change software development from a _craft_, where skilled artisans can create oneoff works, to an _engineering_ discipline, which implies repeatability, rigor, and effective
...
We also address the critically important issue of _trade-off analysis_ . As a software
...
**xiv** **|** **Preface: Invalidating Axioms**
...
_[http://fundamentalsofsoftwarearchitecture.com](http://fundamentalsofsoftwarearchitecture.com)_ .
...
includes the title, author, publisher, and ISBN. For example: “ _Fundamentals of Soft‐_
_ware Architecture_ by Mark Richards and Neal Ford (O’Reilly). Copyright 2020 Mark
...
**Preface: Invalidating Axioms** **|** **xv**
...
O’Reilly and 200+ other publishers. For more information, please visit _[http://](http://oreilly.com)_
_[oreilly.com](http://oreilly.com)_ .
##### **How to Contact Us**
...
information. You can access this page at _[https://oreil.ly/fundamentals-of-software-](https://oreil.ly/fundamentals-of-software-architecture)_
_[architecture](https://oreil.ly/fundamentals-of-software-architecture)_ .
...
**xvi** **|** **Preface: Invalidating Axioms**
...
ers we appreciate. We would also like to thank a few random oases of sanitypreserving and idea-sparking groups that have names like Pasty Geeks and the
Hacker B&B.
...
**Preface: Invalidating Axioms** **|** **xvii**
...
the world. Yet when readers look at the _other_ jobs on those lists (like nurse practi‐
...
[the only ones. In his famous whitepaper “Who Needs an Architect?” Martin Fowler](https://oreil.ly/-Dbzs)
...
_Figure 1-1. The responsibilities of a software architect encompass technical abilities, soft_
_skills, operational awareness, and a host of others_
...
[lessly outdated in a few years. The Wikipedia definition of software architecture pro‐](https://oreil.ly/YLsY2)
...
Some architects refer to software architecture as the _blueprint_ of the system, while
others define it as the _roadmap_ for developing a system. The issue with these com‐
mon definitions is understanding what the blueprint or roadmap actually contains.
For example, what is analyzed when an architect _analyzes_ an architecture?
...
software architecture consists of the _structure_ of the system (denoted as the heavy
black lines supporting the architecture), combined with _architecture characteristics_
(“-ilities”) the system must support, _architecture decisions_, and finally _design princi‐_
_ples_ .


_Figure 1-2. Architecture consists of the structure combined with architecture characteris‐_
_tics (“-ilities”), architecture decisions, and design principles_


**4** **|** **Chapter 1: Introduction**


The _structure_ of the system, as illustrated in Figure 1-3, refers to the type of architec‐
...
architect is only talking about the _structure_ of the system, but not the _architecture_ of
...
_Figure 1-3. Structure refers to the type of architecture styles used in the system_
...
_Figure 1-4. Architecture characteristics refers to the “-ilities” that the system must_
_support_


The next factor that defines software architecture is _architecture decisions_ . Architec‐
...
_Figure 1-5. Architecture decisions are rules for constructing systems_
...
through something called a _variance_ . Most organizations have variance models that
...
The last factor in the definition of architecture is _design principles_ . A design principle
differs from an architecture decision in that a design principle is a _guideline_ rather
than a hard-and-fast _rule_ . For example, the design principle illustrated in Figure 1-6
...
_Figure 1-6. Design principles are guidelines for constructing systems_
...
defining the role, we recommend focusing on the _expectations_ of an architect.
...
_An architect is expected to define the architecture decisions and design principles used to_
_guide technology decisions within the team, the department, or across the enterprise_ .

_Guide_ is the key operative word in this first expectation. An architect should _guide_
rather than _specify_ technology choices. For example, an architect might make a deci‐
...
opment teams to use a _reactive-based framework for frontend web development_, hence
...
architecture decision is helping to _guide_ teams in making the right technical choice or
whether the architecture decision _makes_ the technical choice for them. That said, an
...
_An architect is expected to continually analyze the architecture and current technology_
_environment and then recommend solutions for improvement._

This expectation of an architect refers to _architecture vitality_, which assesses how via‐
ble the architecture that was defined three or more years ago is _today_, given changes
...
_An architect is expected to ensure compliance with architecture decisions and design_
_principles._
...
_An architect is expected to have exposure to multiple and diverse technologies, frame‐_
_works, platforms, and environments._
...
_An architect is expected to possess exceptional interpersonal skills, including teamwork,_
_facilitation, and leadership._
...
solve technical problems, not people problems. However, as [Gerald Weinberg was](https://oreil.ly/wyDB8)
...
_An architect is expected to understand the political climate of the enterprise and be able_
_to navigate the politics._
...
[the strategy pattern to reduce the overall cyclomatic complexity of a particular piece](https://oreil.ly/QG3RQ)
...
makes the decision to create what are called _application silos_, where each application
...
The main point is that _almost every decision an architect makes will be challenged_ .
...
upon software architecture. It is useful to separate software development _process_ from
_engineering practices_ . By _process_, we mean how teams are formed and managed, how
meetings are conducted, and workflow organization; it refers to the mechanics of
how people organize and interact. Software _engineering_ practices, on the other hand,
...
The origins of [Extreme Programming (XP) nicely illustrate the difference between](http://www.extremeprogramming.org)
_process_ and _engineering_ . In the early 1990s, a group of experienced software develop‐
...
focused on the _practices_ that led to project success in the past, pushed to the extreme.
...
development continued with the book _Continuous Delivery_ (Addison-Wesley Profes‐
...
because we’re traditionally bad at estimation, at least in part because of _unknown_
_unknowns_ .
...
list of _known unknowns_ : things developers must learn about the domain and technol‐
ogy they know are upcoming. However, projects also fall victim to _unknown_
_unknowns_ : things no one knew were going to crop up yet have appeared unexpect‐
...
All architectures become iterative because of _unknown unknowns_, Agile just recognizes
...
architecture. Neal’s most recent book, _[Building Evolutionary Architectures](http://shop.oreilly.com/product/0636920080237.do)_ (O’Reilly),
...
_Figure 1-7. The architecture for a software system consists of both requirements and all_
_the other architectural characteristics_
...
ment ecosystem. What we need is an _evolutionary architecture_ .


**16** **|** **Chapter 1: Introduction**


_Building Evolutionary Architectures_ introduces the concept of using _fitness functions_ to
...
_Building Evolutionary Architectures_ co-opts this idea to create _architectural fitness_
_functions_ : an objective integrity assessment of some architectural characteristic(s).
...
software development; they often outsource operations to another company as a costsaving measure. Many architectures designed during the 1990s and 2000s assumed
...
development process; the way that you build software ( _process_ ) has little impact on
the software architecture ( _structure_ ). Thus, while the software development process a
...
[the Strangler Pattern and feature toggles.](https://oreil.ly/ZRpCc)
...
ticular, when we talk about the operational aspects of architecture and _architectural_
_quantum_ (see “Architectural Quanta and Granularity” on page 92), we include impor‐
...
ments do exist. The authors have first and foremost learned the _First Law of Software_
_Architecture_ by constantly stumbling across it:
...
If an architect thinks they have discovered something that _isn’t_ a trade-off, more likely
they just haven’t _identified_ the trade-off yet.
...
tion of structural elements, reflected in our _Second Law of Software Architecture_ :
...
grams representing the topology. In other words, we captured _how_ they solved the
problem but not _why_ the team made particular choices. An architect can look at an
...
Throughout the book, we highlight _why_ architects make certain decisions along with
...
This is called _architectural thinking_ . Unfortunately, too many architects believe that
...
_Figure 2-1. Traditional view of architecture versus design_
...
_Figure 2-2. Making architecture work through collaboration_
...
developer, who must have a significant amount of _technical depth_ to perform their
job, a software architect must have a significant amount of _technical breadth_ to think
...
_Figure 2-3. The pyramid representing all knowledge_


As shown in Figure 2-3, any individual can partition all their knowledge into three
sections: _stuff you know_, _stuff you know you don’t know_, and _stuff you don’t know you_
_don’t know_ .

_Stuff you know_ includes the technologies, frameworks, languages, and tools a technol‐
ogist uses on a daily basis to perform their job, such as knowing Java as a Java pro‐
grammer. _Stuff you know you don’t know_ includes those things a technologist knows a
...
_heard_ of Clojure and know it’s a programming language based on Lisp, but they can’t
code in the language. _Stuff you don’t know you don’t know_ is the largest part of the
...
and related artifacts, it adds to their stock of _stuff you know you don’t know_ .

In Figure 2-4, expanding the top of the pyramid is beneficial because expertise is val‐
ued. However, the _stuff you know_ is also the _stuff you must maintain_ —nothing is static
...
top of an individual’s pyramid is their _technical depth_ .


_Figure 2-4. Developers must maintain expertise to retain it_
...
role. A large part of the value of an architect is a _broad_ understanding of technology
...
are the top _and_ middle sections; how far the middle section penetrates into the bot‐
tom section represents an architect’s technical _breadth_, as shown in Figure 2-5.


_Figure 2-5. What someone knows is technical depth, and how much someone knows is_
_technical breadth_


As an architect, _breadth_ is more important than _depth_ . Because architects must make
...
_Figure 2-6. Enhanced breadth and shrinking depth for the architect role_


Our knowledge pyramid illustrates how fundamentally different the role of _architect_
compares to _developer_ . Developers spend their whole careers honing expertise, and
...
and working themselves ragged in the process. Second, it manifests as _stale expertise_
...
A behavioral anti-pattern commonly observed in the wild, the _Frozen Caveman Anti-_
_Pattern_, describes an architect who always reverts back to their pet irrational concern
...
_Everything_ in architecture is a trade-off, which is why the famous answer to every
...
architecture style, because it _does_ depend. It depends on the deployment environ‐
...
_Figure 2-7. Auction system example of a trade-off—queues or topics?_
...
_Figure 2-8. Use of a topic for communication between services_


**Analyzing Trade-Offs** **|** **31**


_Figure 2-9. Use of queues for communication between services_


The clear advantage (and seemingly obvious solution) to this problem in Figure 2-8 is
that of _architectural extensibility_ . The `Bid Producer` service only requires a single
...
With this analysis it seems clear that the topic approach using the publish-andsubscribe messaging model is the obvious and best choice. However, to quote Rich
...
solution. In analyzing the differences, notice first in Figure 2-8 that with a topic, _any‐_
_one_ can access bidding data, which introduces a possible issue with data access and
data security. In the queue model illustrated in Figure 2-9, the data sent to the queue
can _only_ be accessed by the specific consumer receiving that message. If a rogue ser‐
...
[that this trade-off is technology specific in that the Advanced Message Queuing Pro‐](https://www.amqp.org)
[tocol (AMQP) can support programmatic load balancing and monitoring because of](https://www.amqp.org)
...
_Table 2-1. Trade-offs for topics_
...
The point here is that _everything_ in software architecture has a trade-off: an advantage
...
write Java code in [ArchUnit in the Java platform to automate architectural compli‐](https://www.archunit.org)
[ance, or write custom fitness functions to ensure architectural compliance while gain‐](https://evolutionaryarchitecture.com)
...
While the architect is not actually writing code, at least they are _involved_ in the source
...
way of grouping related code together into _modules_ . While this concept is universal in
...
Preserving good modularity exemplifies our definition of an _implicit_ architecture
...
The dictionary defines _module_ as “each of a set of standardized parts or independent
units that can be used to construct a more complex structure.” We use _modularity_ to
...
[cate this further by adding programming constructs such as the metaobject protocol](https://oreil.ly/9Zw-J)
...
March of 1968, Edsger Dijkstra published a letter in the _Communications of the ACM_
...
This paper helped usher in the era of _structured_ programming languages, exemplified
...
things together logically. Thus, the short era of _modular_ languages was born, such as
Modula (Pascal creator Niklaus Wirth’s next language) and Ada. These languages had
the programming construct of a _module_, much as we think about packages or name‐
...
It is worth noting the general concept of _namespace_, separate from the technical
...
_order_ and an installation _order_ : both named _order_ but with very different connota‐
...
tects understand modularity. We focus on three key concepts: _cohesion_, _coupling_, and
_connascence_ .

**Cohesion**

_Cohesion_ refers to what extent the parts of a module should be contained within the
...
Despite having seven variants listed, _cohesion_ is a less precise metric than _coupling_ .
...
[cohesion). A well-known set of metrics named the Chidamber and Kemerer Object-](https://oreil.ly/-1lMh)
[oriented metrics suite was developed by the eponymous authors to measure particu‐](https://oreil.ly/-1lMh)
...
_Equation 3-1. LCOM, version 1_

_P_      - _Q_, if _P_      - _Q_
_LCOM_ =


_P_ increases by one for any method that doesn’t access a particular shared field and _Q_
...
name _LCOM96B_ ) appears in Equation 3-2.


**42** **|** **Chapter 3: Modularity**


_Equation 3-2. LCOM 96b_
...
many other methods only access `b` . The _sum_ of the sets of methods not shared via
sharing fields ( `a` and `b` ) is high; therefore, this class reports a high LCOM score, indi‐
cating that it scores high in _lack of cohesion in methods_ . Consider the three classes
shown in Figure 3-1.


_Figure 3-1. Illustration of the LCOM metric, where fields are octagons and methods are_
_squares_
...
metric can find is _structural_ lack of cohesion; it has no way to determine logically if
particular pieces fit together. This reflects back on our Second Law of Software Archi‐
tecture: prefer _why_ over _how_ .
...
published _Structured Design: Fundamentals of a Discipline of Computer Program and_
_Systems Design_ (Prentice-Hall), defining many core concepts, including the metrics
_afferent_ and _efferent_ coupling. _Afferent_ coupling measures the number of _incoming_
connections to a code artifact (component, class, function, and so on). _Efferent_ cou‐
pling measures the _outgoing_ connections to other code artifacts. For virtually every
...
alike? These terms originate from Yourdon and Constantine’s _Structured Design_ . Bor‐
...
than clarity, developers came up with several mnemonics to help out: _a_ appears
before _e_ in the English alphabet, corresponding to _incoming_ being before _outgoing_, or
the observation that the letter _e_ in efferent matches the initial letter in _exit_, corre‐
...
_Abstractness_ is the ratio of abstract artifacts (abstract classes, interfaces, and so on) to
...
In the equation, _m_ _[a]_ represents _abstract_ elements (interfaces or abstract classes) with
the module, and _m_ _[c]_ represents _concrete_ elements (nonabstract classes). This metric
...
Architects calculate _abstractness_ by calculating the ratio of the sum of abstract arti‐
facts to the sum of the concrete ones.

Another derived metric, _instability_, is defined as the ratio of efferent coupling to the
sum of both efferent and afferent coupling, shown in Equation 3-4.


_Equation 3-4. Instability_
...
In the equation, _c_ _[e]_ represents _efferent_ (or outgoing) coupling, and _c_ _[a]_ represents _affer‐_
_ent_ (or incoming) coupling.

The _instability_ metric determines the volatility of a code base. A code base that exhib‐
...
One of the few holistic metrics architects have for architectural structure is _distance_
_from the main sequence_, a derived metric based on _instability_ and _abstractness_, shown
in Equation 3-5.


_Equation 3-5. Distance from the main sequence_

_D_ = _A_ + _I_ −1


In the equation, `A` = _abstractness_ and I = _instability_ .

Note that both _abstractness_ and _instability_ are fractions whose results will always fall
...
_Figure 3-2. The main sequence defines the ideal relationship between abstractness and_
_instability_


The _distance_ metric imagines an ideal relationship between abstractness and instabil‐
...
calculate the _distance from the main sequence_ metric, illustrated in Figure 3-3.


**46** **|** **Chapter 3: Modularity**


_Figure 3-3. Normalized distance from the main sequence for a particular class_
...
too far into the upper-righthand corner enter into what architects call the _zone of use‐_
_lessness_ : code that is too abstract becomes difficult to use. Conversely, code that falls
into the lower-lefthand corner enter the _zone of pain_ : code with too much implemen‐
tation and not enough abstraction becomes brittle and hard to maintain, illustrated in
Figure 3-4.


_Figure 3-4. Zones of Uselessness and Pain_
...
page 79) measures complexity in code bases but cannot distinguish from _essential_
complexity (because the underlying problem is complex) or _accidental complexity_ (the
...
stantine ( _Structured Design: Fundamentals of a Discipline of Computer Program and_
_Systems Design_ ) predates the popularity of object-oriented languages, focusing
...
supplanted by _connascence_ .

**Connascence**

In 1996, Meilir Page-Jones published _What Every Programmer Should Know About_
_Object-Oriented Design_ (Dorset House), refining the afferent and efferent coupling
metrics and recasting them to object-oriented languages with a concept he named
_connascence_ . Here’s how he defined the term:
...
He developed two types of connascence: _static_ and _dynamic_ .


**Static connascence**

_Static connascence_ refers to source-code-level coupling (as opposed to execution-time
coupling, covered in “Dynamic connascence” on page 50); it is a refinement of the
afferent and efferent couplings defined by _Structured Design_ . In other words, archi‐
tects view the following types of static connascence as the _degree_ to which something
...
[selective typing, notably Clojure and Clojure Spec.](https://clojure.org)

_Connascence of Meaning (CoM) or Connascence of Convention (CoC)_
...
_Connascence of Position (CoP)_
...
_Connascence of Algorithm (CoA)_
...
The other type of connascence Page-Jones defined was _dynamic connascence_, which
analyzes calls at runtime. The following is a description of the different types of
dynamic connascence:

_Connascence of Execution (CoE)_
...
_Connascence of Identity (CoI)_
...
_Strength_
Architects determine the _strength_ of connascence by the ease with which a devel‐
...
improve static connascence. For example, consider the case of _connascence of_
_meaning_, which developers can improve by refactoring to _connascence of name_ by
creating a named constant rather than a magic value.


_Figure 3-5. The strength on connascence provides a good refactoring guide_


_Locality_
The _locality_ of connascence measures how proximal the modules are to each
...
_Degree_
The _degree_ of connascence relates to the size of its impact—does it impact a few
...
appear on the right. What structured programming called _data coupling_ (method
...
**52** **|** **Chapter 3: Modularity**


_Figure 3-6. Unifying coupling and connascence_
...
tects tend to care more about _how_ modules are coupled rather than the _degree_ of cou‐
...
We use the term _module_ throughout as a generic name for a bundling of related code.
However, most platforms support some form of _component_, one of the key building
...
_Figure 4-1. A software solution consists of both domain requirements and architectural_
_characteristics_
...
the software must do that isn’t directly related to the domain functionality: _architec‐_
_tural characteristics_ .
...
tions describe these features of software with a variety of terms, including _nonfunc‐_
_tional requirements_, but we dislike that term because it is self-denigrating. Architects
created that term to distinguish architecture characteristics from _functional require‐_
_ments_, but naming something _nonfunctional_ has a negative impact from a language
standpoint: how can teams be convinced to pay enough attention to something “non‐
functional”? Another popular term is _quality attributes_, which we dislike because it


**55**


implies after-the-fact quality assessment rather than design. We prefer _architecture_
_characteristics_ because it describes concerns critical to the success of the architecture,
...
_Figure 4-2. The differentiating features of architecture characteristics_


The definition illustrated in Figure 4-2 consists of the three components listed, in
addition to a few modifiers:

_Specifies a nondomain design consideration_
...
_Influences some structural aspect of the design_
...
require special structural consideration to succeed? For example, _security_ is a
...
_Third-party payment processor_
...
_In-application payment processing_
...
_Critical or important to application success_
Applications _could_ support a huge number of architecture characteristics…but
...
**Architecture Characteristics Defined** **|** **57**
...
_Table 4-1. Common operational architecture characteristics_
...
_Table 4-2. Structural architecture characteristics_
...
_Table 4-3. Cross-cutting architecture characteristics_
...
what the team eventually called _Italy-ility_, which they all knew meant a unique combi‐
...
because of subtle nuance or the lack of objective definitions. For example, _interopera‐_
_bility_ and _compatibility_ may appear equivalent, which will be true for some systems.
However, they differ because _interoperability_ implies ease of integration with other
systems, which in turn implies published, documented APIs. _Compatibility_, on the
other hand, is more concerned with industry and domain standards. Another exam‐
ple is _learnability_ . One definition is how easy it is for users to learn to use the soft‐
...
[(ISO) publishes a list organized by capabilities, overlapping many of the ones we’ve](https://oreil.ly/SKc_Y)


**60** **|** **Chapter 4: Architecture Characteristics Defined**
...
known conditions. This includes _time behavior_ (measure of response, processing
times, and/or throughput rates), _resource utilization_ (amounts and types of
resources used), and _capacity_ (degree to which the maximum established limits
are exceeded).
...
tions while sharing the same hardware or software environment. It includes _coex‐_
_istence_ (can perform its required functions efficiently while sharing a common
environment and resources with other products) and _interoperability_ (degree to
...
purpose. It includes _appropriateness recognizability_ (users can recognize whether
the software is appropriate for their needs), _learnability_ (how easy users can learn
how to use the software), _user error protection_ (protection against users making
errors), and _accessibility_ (make the software available to people with the widest
range of characteristics and capabilities).

_Reliability_
Degree to which a system functions under specified conditions for a specified
period of time. This characteristic includes subcategories such as _maturity_ (does
the software meet the reliability needs under normal operation), _availability_
(software is operational and accessible), _fault tolerance_ (does the software operate
as intended despite hardware or software faults), and _recoverability_ (can the soft‐
...
els of authorization. This family of characteristics includes _confidentiality_ (data is
accessible only to those authorized to have access), _integrity_ (the software pre‐
vents unauthorized access to or modification of software or data), _nonrepudia‐_
_tion_, (can actions or events be proven to have taken place), _accountability_ (can
user actions of a user be traced), and _authenticity_ (proving the identity of a user).
...
ment and/or requirements. This characteristic includes _modularity_ (degree to
which the software is composed of discrete components), _reusability_ (degree to
which developers can use an asset in more than one system or in building other
assets), _analyzability_ (how easily developers can gather concrete metrics about
the software), _modifiability_ (degree to which developers can modify the software
without introducing defects or degrading existing product quality), and _testability_
...
This characteristic includes the subcharacteristics of _adaptability_ (can developers
effectively and efficiently adapt the software for different or evolving hardware,
software, or other operational or usage environments), _installability_ (can the soft‐
ware be installed and/or uninstalled in a specified environment), and _replaceabil‐_
_ity_ (how easily developers can replace the functionality with other software).
...
**62** **|** **Chapter 4: Architecture Characteristics Defined**
...
architect wants to improve _security_, it will almost certainly negatively impact _perfor‐_
_mance_ : the application must do more on-the-fly encryption, indirection for secrets
...
Never shoot for the _best_ architecture, but rather the _least worst_
architecture.
...
**64** **|** **Chapter 4: Architecture Characteristics Defined**
...
mon anti-pattern in architecture entails trying to design a _generic architecture_, one
that supports _all_ the architecture characteristics. Each architecture characteristic the
...
_Table 5-1. Translation of domain concerns to architecture characteristics_
...
procrastinate knows the answer to this question! Rarely will details like this appear in
...
acteristics from domain-targeted descriptions. From Japan and martial arts, a _kata_ is
...
Neal updated the format a few years later on [his blog to add the](http://nealford.com/katas) _additional context_
...
**68** **|** **Chapter 5: Identifying Architectural Characteristics**


analysis, either on the spot or from a short analysis after the fact. The design won’t be
...
To illustrate several concepts, we use an _architecture kata_ (see “The Origin of Archi‐
...
Thus, _scalability_ —the ability to handle a large number of concurrent users without
...
However, we also probably need _elasticity_ —the ability to handle bursts of requests.
...
_Figure 5-1. Scalability measures the performance of concurrent users_


_Elasticity_, on the other hand, measures bursts of traffic, as shown in Figure 5-2.


**70** **|** **Chapter 5: Identifying Architectural Characteristics**


_Figure 5-2. Elastic systems must withstand bursts of users_
...
This requirement will primarily affect the _design_ of the application, pointing
...
This requirement implies _internationalization_, or _i18n_ . Many design techniques
...
_performance_ : no one wants to buy from a sandwich shop that has poor performance,
especially at peak times. However, _performance_ is a nuanced concept—what _kind_ of
...
istic the system might want to support is _availability_ : making sure users can access the
sandwich site. Closely related to availability is _reliability_ : making sure the site stays up
during interactions—no one wants to purchase from a site that continues dropping
connections, forcing them to log in again.

_Security_ appears as an implicit characteristic in every system: no one wants to create
...
encompasses several details from the requirements: _customizability_ . Notice that sev‐
...
leads to the dreaded _Ivory Tower Architect_ anti-pattern). In the case of Silicon Sand‐
...
_They aren’t physics_
Many architecture characteristics in common usage have vague meanings. For
example, how does an architect design for _agility_ or _deployability_ ? The industry
...
_Wildly varying definitions_

Even within the same organization, different departments may disagree on the
definition of critical features such as _performance_ . Until developers, architecture,
...
Many forward-thinking organizations place _K-weight budgets_ for page downloads: a
...
**78** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**


High-level teams don’t just establish hard performance numbers; they base their defi‐
...
focused on performance budgets for metrics such as _first contentful paint_ and _first_
_CPU idle_, both of which speak volumes about performance issues for users of web‐
...
An obvious measurable aspect of code is complexity, defined by the _cyclomatic com‐_
_plexity_ metric.


**Cyclomatic Complexity**

[Cyclomatic Complexity (CC) is a code-level metric designed to provide an object](https://oreil.ly/mAHFZ)
...
The formula for calculating the CC for a single function or method is _CC_ = _E_  - _N_ + 2,
where `N` represents _nodes_ (lines of code), and `E` represents _edges_ (possible decisions).
Consider the C-like code shown in Example 6-1.


**Measuring Architecture Characteristics** **|** **79**


_Example 6-1. Sample code for cyclomatic complexity evaluation_
...
_Figure 6-1. Cyclomatic Complexity for the decision function_
...
_connected components_ in graph theory), the more general formula is _CC_ = _E_  - _N_ + 2 _P_,
where _P_ represents the number of connected components.
...
**80** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**
...
code. A metrics tool in the Java world, [Crap4J, attempts to determine how poor](http://www.crap4j.org)
...
_Governance_, derived from the Greek word _kubernan_ (to steer) is an important
...
[spawned by Extreme Programming created continuous integration, which led to fur‐](http://www.extremeprogramming.org)
ther automation into operations, which we now call DevOps, continuing through to
architectural governance. The book _[Building Evolutionary Architectures](http://shop.oreilly.com/product/0636920080237.do)_ (O’Reilly)
describes a family of techniques, called fitness functions, used to automate many
aspects of architecture governance.


**82** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**


**Fitness Functions**

The word “evolutionary” in _Building Evolutionary Architectures_ comes more from
...
indicating the quality of the outcome. That guidance mechanism is called a _fitness_
_function_ : an object function used to assess how close the output comes to achieving
[the aim. For example, suppose a developer needed to solve the traveling salesperson](https://oreil.ly/GApjt)
[problem, a famous problem used as a basis for machine learning. Given a salesperson](https://oreil.ly/GApjt)
...
Practices in evolutionary architecture borrow this concept to create an _architecture_
_fitness function_ :

_Architecture fitness function_
...
a new perspective on many existing tools. Notice in the definition the phrase _any_
_mechanism_ —the verification techniques for architecture characteristics are as varied
...
**Governance and Fitness Functions** **|** **83**


_Figure 6-2. The mechanisms of fitness functions_
...
**84** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**


_Figure 6-3. Cyclic dependencies between components_
...
toward the [Big Ball of Mud anti-pattern. How can architects govern this behavior](https://oreil.ly/usx7p)
...
_Example 6-2. Fitness function to detect component cycles_
...
**Governance and Fitness Functions** **|** **85**
...
In the code, an architect uses the metrics tool [JDepend to check the dependencies](https://oreil.ly/ozzzk)
...
project and stop worrying about the accidental introduction of cycles by triggerhappy developers. This is a great example of a fitness function guarding the impor‐
...
_Example 6-3. Distance from the main sequence fitness function_
...
**86** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**


The sophistication of fitness function tools has increased over the last few years,
including some special purpose tools. One such tool is [ArchUnit, a Java testing](https://www.archunit.org)
[framework inspired by and using several parts of the JUnit ecosystem. ArchUnit pro‐](https://junit.org)
...
_Figure 6-4. Layered architecture_
...
_Example 6-4. ArchUnit fitness function to govern layers_
...
**Governance and Fitness Functions** **|** **87**


[A similar tool in the .NET space, NetArchTest, allows similar tests for that platform; a](https://oreil.ly/EMXpv)
layer verification in C# appears in Example 6-5.


_Example 6-5. NetArchTest for layer dependencies_
...
[Simian Army. In particular, the](https://oreil.ly/GipHq) _Conformity_, _Security_, and _Janitor_ Monkeys exemplify
...
**88** **|** **Chapter 6: Measuring and Governing Architecture Characteristics**


A few years ago, the influential book _[The Checklist Manifesto](https://oreil.ly/XNcV9)_ by Atul Gawande (Pica‐
...
**Governance and Fitness Functions** **|** **89**
...
During the writing of the _[Building Evolutionary Architectures](http://evolutionaryarchitecture.com)_ book, the authors
...
cies. That lead the _Building Evolutionary Architectures_ authors to define the term
_architecture quantum_ . To understand the architecture quantum definition, we must
...
Many of the code-level coupling metrics, such as _afferent_ and _efferent_ coupling
...
_What Every Programmer Should Know About Object Oriented Design_ (Dorset House)
that included several new measures of coupling he named _connascence_, which is
defined as follows:
...
He defined two types of connascence: _static_, discoverable via static code analysis, and
_dynamic_, concerning runtime behavior. To define the architecture quantum, we
...
share the same class definition of some class, like _address_, we say they are _statically_
connascent with each other—changing the shared class requires changes to both
services.

For dynamic connascence, we define two types: _synchronous_ and _asynchronous_ . Syn‐
chronous calls between two distributed services have the caller wait for the response
from the callee. On the other hand, _asynchronous_ calls allow fire-and-forget seman‐
...
business concepts semantically bind parts of the system together, creating _functional_
_cohesion_ . To successfully design, analyze, and evolve software, developers must con‐
...
the _bounded context_ driving philosophy in microservices, described in detail in
Chapter 17), creating multiple quanta within that architecture.

_High functional cohesion_
_Cohesion_ in component design refers to how well the contained code is unified in
purpose. For example, a `Customer` component with properties and methods all
pertaining to a _Customer_ entity exhibits high cohesion; whereas a `Utility` com‐
ponent with a random collection of miscellaneous methods would not.

_High functional cohesion_ implies that an architecture quantum does something
...
cally design each service to match a single workflow (a _bounded context_, as
described in “Domain-Driven Design’s Bounded Context” on page 94), thus
exhibiting high functional cohesion.

_Synchronous connascence_
_Synchronous connascence_ implies synchronous calls within an application context
...
and connascence, which didn’t include our new _communication connascence_ measure.
We update this diagram in Figure 7-1.


**Architectural Quanta and Granularity** **|** **93**


_Figure 7-1. Adding quantum connascence to the unified diagram_
...
Eric Evans’ book _Domain-Driven Design_ (Addison-Wesley Professional) has deeply
influenced modern architectural thinking. _[Domain-driven design](https://dddcommunity.org)_ (DDD) is a model‐
ing technique that allows for organized decomposition of complex problem domains.
DDD defines the _bounded context_, where everything related to the domain is visible
...
tion, and increased complexity. The _bounded context_ concept recognizes that each
...
**94** **|** **Chapter 7: Scope of Architecture Characteristics**


The architecture quantum concept provides the new scope for architecture character‐
...
measure, consider another architecture kata, _Going, Going, Gone_ .
...
**Architectural Quanta and Granularity** **|** **95**


Each of these requirements implies both scalability to support the sheer number
...
_track_ part of the requirement might suggest some architecture characteristics
...
**96** **|** **Chapter 7: Scope of Architecture Characteristics**


seek out a business analyst or other subject matter expert to explain what they
...
when architects discuss _elasticity_, the ability to handle bursts of users, they can
...
encompassed by the domain _and_ requires particular structure, which elevates a
...
**Architectural Quanta and Granularity** **|** **97**


This last requirement in the Going, Going, Gone kata highlights the need for a more
...
**98** **|** **Chapter 7: Scope of Architecture Characteristics**
...
In Chapter 3, we discussed _modules_ as a collection of related code. However, archi‐
tects typically think in terms of _components_, the physical manifestation of a module.

Developers physically package modules in different ways, sometimes depending on
their development platform. We call physical packaging of modules _components_ . Most
...
Developers find it useful to subdivide the concept of _component_ based on a wide host
...
wraps code at a higher level of modularity than classes (or functions, in nonobjectoriented languages). This simple wrapper is often called a _library_, which tends to run
...
_Figure 8-1. Different varieties of components_


Components also appear as subsystems or layers in architecture, as the deployable
unit of work for many event processors. Another type of component, a _service_, tends
to run in its own address space and communicates via low-level networking protocols
like TCP/IP or higher-level formats like REST or message queues, forming standalone, deployable units in architectures like microservices.
...
**100** **|** **Chapter 8: Component-Based Thinking**


_Figure 8-2. A microservice might have so little code that components aren’t necessary_
##### **Architect Role**
...
The First Law of Software Architecture states that everything in software is a tradeoff, including how architects create components in an architecture. Because compo‐
nents represent a general containership mechanism, an architect can build any type
of partitioning they want. Several common styles exist, with different sets of tradeoffs. We discuss architecture styles in depth in Part II. Here we discuss an important
aspect of styles, the _top-level partitioning_ in an architecture.

Consider the two types of architecture styles shown in Figure 8-3.


_Figure 8-3. Two types of top-level architecture partitioning: layered and modular_


In Figure 8-3, one type of architecture familiar to many is the _layered monolith_ (dis‐
cussed in detail in Chapter 10). The other is an architecture style popularized by
[Simon Brown called a](https://www.codingthearchitecture.com) _modular monolith_, a single deployment unit associated with a
database and partitioned around domains rather than technical capabilities. These
two styles represent different ways to _top-level partition_ the architecture. Note that in
...
**102** **|** **Chapter 8: Component-Based Thinking**


Organizing architecture based on technical capabilities like the layered monolith rep‐
resents _technical top-level partitioning_ . A common version of this appears in
Figure 8-4.


_Figure 8-4. Two types of top-level partitioning in architecture_


In Figure 8-4, the architect has partitioned the functionality of the system into _techni‐_
_cal_ capabilities: presentation, business rules, services, persistence, and so on. This way
...
the DBAs in another, the presentation team in another, and so on. Because of _Con‐_
_way’s law_, this makes some sense in those organizations.


**Conway’s Law**

[Back in the late 1960s, Melvin Conway made an observation that has become known](https://oreil.ly/z2Swa)
as _Conway’s law_ :
...
design. People at all levels of organizations see this law in action, and they sometimes
...
[A related observation coined by Jonny Leroy of ThoughtWorks is the Inverse Conway](https://oreil.ly/9EYd6)
[Maneuver, which suggests evolving team and organizational structure together to](https://oreil.ly/9EYd6)
promote the desired architecture.


The other architectural variation in Figure 8-4 represents _domain partitioning_,
inspired by the Eric Evan book _Domain-Driven Design_, which is a modeling techni‐
...
of the components in Figure 8-4 in the domain partitioning (for example, _Catalog‐_
_Checkout_ ) may use a persistence library and have a separate layer for business rules,
...
of the organizing principles of this architecture is _separation of technical concerns_ .
...
Consider the common business workflow of _CatalogCheckout_ . The code to handle
_CatalogCheckout_ in the technically layered architecture appears in all the layers, as
shown in Figure 8-5.


**104** **|** **Chapter 8: Component-Based Thinking**


_Figure 8-5. Where domains/workflows appear in technical- and domain-partitioned_
_architectures_


In Figure 8-5, in the technically partitioned architecture, _CatalogCheckout_ appears in
...
_Figure 8-6. A domain-partitioned design for Silicon Sandwiches_
...
_Figure 8-7. A technically partitioned design for Silicon Sandwiches_


**106** **|** **Chapter 8: Component-Based Thinking**
...
_Figure 8-8. Component identification cycle_
...
**108** **|** **Chapter 8: Component-Based Thinking**
...
**Component Identification Flow** **|** **109**
...
lurks: the _entity trap_ . Say that an architect is working on designing components for
our kata Going, Going, Gone and ends up with a design resembling Figure 8-9.


_Figure 8-9. Building an architecture as an object-relational mapping_


**110** **|** **Chapter 8: Component-Based Thinking**


In Figure 8-9, the architect has basically taken each entity identified in the require‐
...
[two projects, a .NET version still called NakedObjects, and a Java version that moved](https://oreil.ly/RQ8XQ)
to the Apache open source foundation under the name [Isis). The premise behind](http://isis.apache.org)
...
[based on database table structure: the scaffolding feature of the Ruby on Rails frame‐](https://rubyonrails.org)
...
The _actor/actions_ approach is a popular way that architects use to map requirements
...
**Component Design** **|** **111**


tion of upfront design. It is still popular and works well when the requirements fea‐
...
_Event storming_ as a component discovery technique comes from domain-driven
...
using DDD or messaging. The _workflow approach_ models the components around
...
None of these techniques is superior to the others; all offer a different set of tradeoffs. If a team uses a waterfall approach or other older software development pro‐
cesses, they might prefer the Actor/Actions approach because it is general. When
using DDD and corresponding architectures like microservices, _event storming_
...
roles: the _bidder_, the _auctioneer_, and a frequent participant in this modeling techni‐
que, the _system_, for internal actions. The roles interact with the application, repre‐
...
**112** **|** **Chapter 8: Component-Based Thinking**
...
_Figure 8-10. Initial set of components for Going, Going, Gone_
...
**Case Study: Going, Going, Gone: Discovering Components** **|** **113**
...
**114** **|** **Chapter 8: Component-Based Thinking**


_Figure 8-11. Incorporating architecture characteristics into GGG component design_
...
A _monolithic_ architecture typically features a single deployable unit, including all
...
lith, discussed fully in Chapter 10. A _distributed_ architecture is the opposite—the
...
**116** **|** **Chapter 8: Component-Based Thinking**
...
fusing. We define an _architecture style_ as the overarching structure of how the user
...
with a datastore. _Architecture patterns_, on the other hand, are lower-level design
...
Architects refer to the absence of any discernible architecture structure as a _Big Ball of_
_Mud_, named after the eponymous anti-pattern defined in a paper released in 1997 by
Brian Foote and Joseph Yoder:

A _Big Ball of Mud_ is a haphazardly structured, sprawling, sloppy, duct-tape-and-balingwire, spaghetti-code jungle. These systems show unmistakable signs of unregulated
...
In modern terms, a _big ball of mud_ might describe a simple scripting application with
...
application as quickly as possible over several years. The technical visualization [1]
...
**120** **|** **Chapter 9: Foundations**


_Figure 9-1. A Big Ball of Mud architecture visualized from a real code base_
...
end and backend, called a _two-tier_, or _client/server_, architecture. Many different fla‐
vors of this architecture exist, depending on the era and computing capabilities.


**Fundamental Patterns** **|** **121**
...
An architecture that became quite popular during the late 1990s was a _three-tier_
_architecture_, which provided even more layers of separation. As tools like application
...
[The three-tier architecture corresponded with network-level protocols such as Com‐](https://www.corba.org)
[mon Object Request Broker Architecture (CORBA) and](https://www.corba.org) [Distributed Component](https://oreil.ly/1TEqv)
[Object Model (DCOM) that facilitated building distributed architectures.](https://oreil.ly/1TEqv)
...
core of the language using a mechanism called _serialization_ . Every `Object` in Java
...
Architecture styles can be classified into two main types: _monolithic_ (single deploy‐
ment unit of all code) and _distributed_ (multiple deployment units connected through
...
Distributed architecture styles, while being much more powerful in terms of perfor‐
...
architectures are described in _[the fallacies of distributed computing](https://oreil.ly/fVAEY)_, first coined by L.
Peter Deutsch and other colleagues from Sun Microsystems in 1994. A _fallacy_ is
...
_Figure 9-2. The network is not reliable_
...
**124** **|** **Chapter 9: Foundations**


**Fallacy #2: Latency Is Zero**


_Figure 9-3. Latency is not zero_
...
**Monolithic Versus Distributed Architectures** **|** **125**


**Fallacy #3: Bandwidth Is Infinite**


_Figure 9-4. Bandwidth is not infinite_
...
a form of coupling referred to as _stamp coupling_ . This may not sound significant, but
...
that _one_ interservice call (out of hundreds being made that second) is 1 Gb!
...
**126** **|** **Chapter 9: Foundations**
 ...
 - [Use GraphQL to decouple contracts](https://graphql.org)
...
_Figure 9-5. The network is not secure_
...
distributed computing: _the network is not secure_ . Security becomes much more chal‐
...
**Monolithic Versus Distributed Architectures** **|** **127**


**Fallacy #5: The Topology Never Changes**


_Figure 9-6. The network topology always changes_
...
tects assume that the topology is fixed and never changes. _Of course it changes_ . It
...
**128** **|** **Chapter 9: Foundations**


**Fallacy #6: There Is Only One Administrator**


_Figure 9-7. There are many network administrators, not just one_
...
**Monolithic Versus Distributed Architectures** **|** **129**


**Fallacy #7: Transport Cost Is Zero**


_Figure 9-8. Remote access costs money_


Many software architects confuse this fallacy for latency (“Fallacy #2: Latency Is Zero”
on page 125). Transport cost here does not refer to latency, but rather to actual _cost_ in
...
simple RESTful call or breaking apart a monolithic application. _It is usually not_ . Dis‐
...
**130** **|** **Chapter 9: Foundations**


**Fallacy #8: The Network Is Homogeneous**


_Figure 9-9. The network is not homogeneous_
...
**Monolithic Versus Distributed Architectures** **|** **131**


different place and all with a different format, making it difficult to track down a
problem.

[Logging consolidation tools such as Splunk help to consolidate information from var‐](https://www.splunk.com)
...
Distributed architectures rely on what is called _eventual consistency_ to ensure the data
...
_[Transactional sagas](https://oreil.ly/1lLmj)_ are one way to manage distributed transactions. Sagas utilize
either event sourcing for compensation or finite state machines to manage the state of
transaction. In addition to sagas, _BASE_ transactions are used. BASE stands for (B)asic
availability, (S)oft state, and (E)ventual consistency. BASE transactions are not a piece
of software, but rather a technique. _Soft state_ in BASE refers to the transit of data
from a source to a target, as well as the inconsistency between data sources. Based on
the _basic availability_ of the systems or services involved, the systems will _eventually_
...
The _layered_ architecture, also known as the _n-tiered_ architecture style, is one of the
...
[also a very natural way to develop applications due to Conway’s law, which states that](https://oreil.ly/Rb4uN)
...
including the _architecture by implication_ anti-pattern and the _accidental architecture_
...
_Figure 10-1. Standard logical layers within the layered architecture style_
...
_Figure 10-2. Physical topology (deployment) variants_
...
**134** **|** **Chapter 10: Layered Architecture Style**
...
This _separation of concerns_ concept within the layered architecture style makes it easy
...
The layered architecture is a _technically partitioned_ architecture (as opposed to a
_domain-partitioned_ architecture). Groups of components, rather than being grouped
...
Each layer in the layered architecture style can be either _closed_ or _open_ . A closed layer
...
_Figure 10-3. Closed layers within the layered architecture_
...
unnecessary layers (what used to be known in the early 2000s as the _fast-lane reader_
_pattern_ ). For this to happen, the business and persistence layers would have to be
_open_, allowing requests to bypass other layers. Which is better—open layers or closed
layers? The answer to this question lies in a key concept known as _layers of isolation_ .

The _layers of isolation_ concept means that changes made in one layer of the architec‐
...
impact both the business layer _and_ the presentation layer, producing a very tightly
...
[use of the business delegate pattern). For example, you can leverage the layers of iso‐](https://oreil.ly/WeKWs)
...
**136** **|** **Chapter 10: Layered Architecture Style**


ity classes, auditing classes, logging classes, and so on). Suppose there is an architec‐
...
layer. This scenario is difficult to govern and control because _architecturally_ the pre‐
sentation layer has access to the business layer, and hence has access to the shared
objects within that layer.


_Figure 10-4. Shared objects within the business layer_
...
ices layer must be marked as _open_ ; otherwise the business layer would be forced to go
...
_Figure 10-5. Adding a new services layer to the architecture_
...
One thing to watch out for with the layered architecture is the _architecture sinkhole_
...
**138** **|** **Chapter 10: Layered Architecture Style**
...
_Figure 10-6. Layered architecture characteristics ratings_
...
**140** **|** **Chapter 10: Layered Architecture Style**


also reflects this scenario; with a simple three-line change, most developers are not
...
and crashes. Furthermore, overall availability is impacted due to the high mean-timeto-recovery (MTTR) usually experienced by most monolithic applications, with
...
**Architecture Characteristics Ratings** **|** **141**
...
the _pipeline_ architecture (also known as the _pipes and filters_ architecture). As soon as
...
[behind Unix terminal shell languages, such as Bash and Zsh.](https://oreil.ly/uP2Bo)
...
the [MapReduce programming model follow this basic topology. While these exam‐](https://oreil.ly/veX6W)
...
_Figure 11-1. Basic topology for pipeline architecture_
...
_Pipes_ in this architecture form the communication channel between filters. Each pipe
...
_Filters_ are self-contained, independent from other filters, and generally stateless. Fil‐
...
_Producer_
The starting point of a process, outbound only, sometimes called the _source_ .
...
on the test. Functional programmers will recognize this as similar to _reduce_ .
...
[famous story from the blog “More Shell, Less Egg” illustrates just how powerful these](https://oreil.ly/ljeb5)
abstractions are. Donald Knuth was asked to write a program to solve this text han‐
dling problem: read a file of text, determine the _n_ most frequently used words, and
...
**144** **|** **Chapter 11: Pipeline Architecture Style**
...
database or data source to another. Orchestrators and mediators such as [Apache](https://camel.apache.org)
[Camel utilize the pipeline architecture to pass information from one step in a busi‐](https://camel.apache.org)
...
[from services via streaming to Apache Kafka.](https://kafka.apache.org)


_Figure 11-2. Pipeline architecture example_


**Example** **|** **145**


Notice in Figure 11-2 the use of the pipeline architecture style to process the different
...
fied data to the `Database Output` [consumer, which then persists the data in a Mon‐](https://www.mongodb.com)
[goDB database.](https://www.mongodb.com)
...
**146** **|** **Chapter 11: Pipeline Architecture Style**


_Figure 11-3. Pipeline architecture characteristics ratings_
...
**Architecture Characteristics Ratings** **|** **147**


Like the layered architecture, overall reliability rates medium (three stars) in this
...
**148** **|** **Chapter 11: Pipeline Architecture Style**
...
The _microkernel_ architecture style (also referred to as the _plug-in_ architecture) was
...
_Figure 12-1. Basic components of the microkernel architecture style_

**Core System**

The _core system_ is formally defined as the minimal functionality required to run the
...
**150** **|** **Chapter 12: Microkernel Architecture Style**


Rather than placing all this client-specific customization in the core system with lots
...
_Figure 12-2. Variations of the microkernel architecture core system_
...
**152** **|** **Chapter 12: Microkernel Architecture Style**


_Figure 12-3. User interface variants_
...
better maintainability and testability within the application. Ideally, plug-in compo‐
...
managed through frameworks such as [Open Service Gateway Initiative (OSGi) for](https://www.osgi.org)
[Java, Penrose (Java), Jigsaw (Java), or Prism (.NET). Compile-based plug-in compo‐](https://www.osgi.org)
...
the electronics recycling assessment application example, each electronic device plugin can be written and implemented as a JAR, DLL, or Ruby Gem (or any other shared
library), with the name of the device matching the name of the independent shared
library, as illustrated in Figure 12-4.


_Figure 12-4. Shared library plug-in implementation_
...
**154** **|** **Chapter 12: Microkernel Architecture Style**


from other plug-ins). The third node describes the domain (in this case, `assessment` ),
...
_Figure 12-5. Package or namespace plug-in implementation_
...
_Figure 12-6. Remote plug-in access using REST_
...
allows for better scalability and throughput, and allows for runtime changes without
...
make an asynchronous _request_ to kick off an assessment for a particular device. When
...
monolithic deployment. The choice of whether to make the communication to plugin components from the core system point-to-point or remote should be based on
...
**156** **|** **Chapter 12: Microkernel Architecture Style**


_Figure 12-7. Plug-in components can own their own data store_
##### **Registry**
...
externally (such as [Apache ZooKeeper or](https://zookeeper.apache.org) [Consul). Using the electronics recycling](https://www.consul.io)
...
[the microkernel architecture. Some examples include the Eclipse IDE, PMD, Jira, and](https://www.eclipse.org/ide)
[Jenkins, to name a few). Internet web browsers such as Chrome and Firefox are](https://jenkins.io)
another common product example using the microkernel architecture: viewers and


**158** **|** **Chapter 12: Microkernel Architecture Style**
...
_Figure 12-8. Microkernel architecture characteristics ratings_
...
**160** **|** **Chapter 12: Microkernel Architecture Style**


The microkernel architecture style is unique in that it is the only architecture style
that can be both domain partitioned _and_ technically partitioned. While most micro‐
...
architectures. Also, they don’t suffer as much from the architecture sinkhole antipattern discussed in Chapter 10. Finally, microkernel architectures can be stream‐
lined by unplugging unneeded functionality, therefore making the application run
[faster. A good example of this is Wildfly (previously the JBoss Application Server). By](https://wildfly.org)
...
**Architecture Characteristics Ratings** **|** **161**
...
_Service-based_ architecture is a hybrid of the microservices architecture style and is
...
application” (usually called _domain services_ ) that are independent and separately
...
_Figure 13-1. Basic topology of the service-based architecture style_


In most cases there is only a single instance of each domain service within a servicebased architecture. However, based on scalability, fault tolerance, and throughput
...
[services directly using a service locator pattern embedded within the user interface,](https://oreil.ly/wYLF2)
...
**164** **|** **Chapter 13: Service-Based Architecture Style**
...
_Figure 13-2. User interface variants_


**Topology Variants** **|** **165**


Similarly, opportunities may exist to break apart a single monolithic database into
...
_Figure 13-3. Database variants_


**166** **|** **Chapter 13: Service-Based Architecture Style**


Finally, it is also possible to add an API layer consisting of a reverse proxy or gateway
...
_Figure 13-4. Adding an API layer between the user interface and domain services_
...
_Figure 13-5. Domain service design variants_
...
**168** **|** **Chapter 13: Service-Based Architecture Style**


tributed architectures like microservices, on the other hand, usually have fine-grained
...
Within a service-based architecture, the shared class files representing the database
table schemas (usually referred to as _entity objects_ ) reside in a custom shared library
...
_Figure 13-6. Using a single shared library for database entity objects_
...
**170** **|** **Chapter 13: Service-Based Architecture Style**


services using that shared library, which in this case is the invoicing service. No other
services are impacted by this change.


_Figure 13-7. Using multiple shared libraries for database entity objects_


Notice in Figure 13-7 the use of the _common_ domain and the corresponding
...
(called _quoting_ ). If satisfied, the customer will send the electronic device to the recy‐
cling company, which in turn will receive the physical device (called _receiving_ ). Once
received, the recycling company will then assess the device to determine if the device
is in good working condition or not (called _assessment_ ). If the device is in good work‐
ing condition, the company will send the customer the money promised for the
device (called _accounting_ ). Through this process, the customer can go to the website
at any time to check on the status of the item (called _item status_ ). Based on the assess‐
ment, the device is then recycled by either safely destroying it or reselling it (called
_recycling_ ). Finally, the company periodically runs ad hoc and scheduled financial and
operational reports based on recycling activity (called _reporting_ ).
...
domains: _Customer Facing_, _Receiving_, and _Recycling and Accounting_ . This federation
...
**172** **|** **Chapter 13: Service-Based Architecture Style**


_Figure 13-8. Electronics recycling example using service-based architecture_
...
_Figure 13-9. Service-based architecture characteristics ratings_


Service-based architecture is a _domain-partitioned_ architecture, meaning that the
...
**174** **|** **Chapter 13: Service-Based Architecture Style**


corresponding database. Nothing else needs to be modified to support a specific
assessment change.
...
_Figure 13-10. Separate quanta in a service-based architecture_


**Architecture Characteristics Ratings** **|** **175**
...
large monolith (deployability). These three characteristics lead to better time-tomarket, allowing an organization to deliver new features and bug fixes at a relatively
high rate.
...
rating comes from the fact that with this architecture style, services are usually selfcontained and do not leverage interservice communication due to database sharing
...
**176** **|** **Chapter 13: Service-Based Architecture Style**
...
use of a central mediator (like dancers in a dance). As services become more finegrained, both orchestration and choreography are necessary to tie the services
...
The _event-driven_ architecture style is a popular distributed asynchronous architecture
...
Most applications follow what is called a _request-based_ model (illustrated in
Figure 14-1). In this model, requests made to the system to perform some sort of
action are send to a _request orchestrator_ . The request orchestrator is typically a user
...
direct the request to various _request processors_ . The request processors handle the
...
_Figure 14-1. Request-based model_
##### **Topology**

There are two primary topologies within event-driven architecture: the _mediator top‐_
_ology_ and the _broker topology_ . The mediator topology is commonly used when you
...
**180** **|** **Chapter 14: Event-Driven Architecture Style**


There are four primary architecture components within the broker topology: an ini‐
tiating event, the event broker, an event processor, and a processing event. The _initiat‐_
_ing event_ is the initial event that starts the entire event flow, whether it be a simple
...
event channel in the _event broker_ for processing. Since there is no mediator compo‐
nent in the broker topology managing and controlling the event, a single _event pro‐_
_cessor_ accepts the initiating event from the event broker and begins the processing of
...
it did to the rest of the system by creating what is called a _processing event_ . This pro‐
...
_Figure 14-3. Notification event is sent but ignored_


This is a good example of _architectural extensibility_ . While it may seem like a waste of
...
**182** **|** **Chapter 14: Event-Driven Architecture Style**


_Figure 14-4. Example of the broker topology_
...
The `Inventory` event processor also listens for the `order-created` processing event
...
**184** **|** **Chapter 14: Event-Driven Architecture Style**
...
_Table 14-1. Trade-offs of the broker topology_
...
_Figure 14-5. Mediator topology_
...
simple error handling and orchestration, a mediator such as [Apache Camel,](https://camel.apache.org) [Mule](https://www.mulesoft.com)
[ESB, or](https://www.mulesoft.com) [Spring Integration will usually suffice. Message flows and message routes](https://oreil.ly/r2e4r)
...
**186** **|** **Chapter 14: Event-Driven Architecture Style**


[Apache ODE or the](https://ode.apache.org) [Oracle BPEL Process Manager would be a good choice. These](https://oreil.ly/jMtta)
mediators are based on [Business Process Execution Language (BPEL), an XML-like](https://oreil.ly/Uu-Fo)
...
[(BPM) engine such as jBPM would be required.](https://www.jbpm.org)
...
**Mediator Topology** **|** **187**


_Figure 14-6. Delegating the event to the appropriate type of event mediator_
...
**188** **|** **Chapter 14: Event-Driven Architecture Style**


_Figure 14-7. Mediator steps for placing an order_
...
**Mediator Topology** **|** **189**


_Figure 14-8. Step 1 of the mediator example_
...
**190** **|** **Chapter 14: Event-Driven Architecture Style**


_Figure 14-9. Step 2 of the mediator example_



**Mediator Topology** **|** **191**


Once the mediator gets a successful acknowledgment from all of the event processors
...
_Figure 14-10. Step 3 of the mediator example_


**192** **|** **Chapter 14: Event-Driven Architecture Style**


Once these events are complete, the mediator then moves on to step 4 (see
...
_Figure 14-11. Step 4 of the mediator example_
...
**Mediator Topology** **|** **193**


_Figure 14-12. Step 5 of the mediator example_
...
**194** **|** **Chapter 14: Event-Driven Architecture Style**
...
rences such as `place-order`, `send-email`, and `fulfill-order` are _commands_ (things
that need to happen) as opposed to _events_ (things that have already happened). Also,
...
_Table 14-2. Trade-offs of the mediator topology_
...
**Mediator Topology** **|** **195**


##### **Asynchronous Capabilities**

The event-driven architecture style offers a unique characteristic over other architec‐
ture styles in that it relies solely on asynchronous communication for both fire-andforget processing (no response required) as well as request/reply processing
...
_Figure 14-13. Synchronous versus asynchronous communication_


**196** **|** **Chapter 14: Event-Driven Architecture Style**


This is a good example of the difference between _responsiveness_ and _performance_ .
...
both cases it is still taking 3,000 milliseconds. Addressing _performance_ would have
...
a pattern of reactive architecture called the _workflow event_ pattern.
##### **Error Handling**
...
the use of a _workflow delegate_, as illustrated in Figure 14-14. The event producer
...
gates that error to the _workflow processor_ and moves on to the next message in the
...
_Figure 14-14. Workflow event pattern of reactive architecture_
...
**198** **|** **Chapter 14: Event-Driven Architecture Style**


purchased. To simplify the example, suppose the contract for the trade instructions
...
The `Trade Placement Error` service (acting as the workflow delegate) receives the
...
_Figure 14-15. Error handling with the workflow event pattern_
...
**200** **|** **Chapter 14: Event-Driven Architecture Style**


##### **Preventing Data Loss**

Data loss is always a primary concern when dealing with asynchronous communica‐
tions. Unfortunately, there are many places for data loss to occur within an eventdriven architecture. By data loss we mean a message getting dropped or never making
...
_Figure 14-16. Where data loss can happen within an event-driven architecture_
...
tent message queues, along with something called _synchronous send_ . Persisted mes‐
...
there is no way to lose a message between the event producer and the queue because
...
called _client acknowledge mode_ . By default, when a message is de-queued, it is imme‐
diately removed from the queue (something called _auto acknowledge_ mode). Client
...
called _last participant support_ (LPS) removes the message from the persisted queue by
...
_Figure 14-17. Preventing data loss within an event-driven architecture_


**202** **|** **Chapter 14: Event-Driven Architecture Style**
...
_Figure 14-18. Broadcasting events to other event processors_
...
_request-reply_ messaging (sometimes referred to as _pseudosynchronous communica‐_
_tions_ ). Each event channel within request-reply messaging consists of two queues: a
...
_Figure 14-19. Request-reply message processing_


There are two primary techniques for implementing request-reply messaging. The
first (and most common) technique is to use a _correlation ID_ contained in the mes‐
...
**204** **|** **Chapter 14: Event-Driven Architecture Style**


2. The event producer now does a blocking wait on the reply queue with a message
...
_Figure 14-20. Request-reply message processing using a correlation ID_


The other technique used to implement request-reply messaging is to use a _temporary_
_queue_ for the reply queue. A temporary queue is dedicated to the specific request, cre‐
...
passing the name of the temporary queue in the reply-to header (or some other
...
_Figure 14-21. Request-reply message processing using a temporary queue_
...
**206** **|** **Chapter 14: Event-Driven Architecture Style**


Understanding the trade-offs with the event-based model also helps decide which one
is the best fit. Table 14-3 lists the advantages and disadvantages of the event-based
model of event-driven architecture.


_Table 14-3. Trade-offs of the event-driven model_
...
cific architecture characteristic isn’t well supported in the architecture, whereas a fivestar rating means the architecture characteristic is one of the strongest features in the
architecture style. The definition for each characteristic identified in the scorecard
can be found in Chapter 4.
...
_Figure 14-22. Event-driven architecture characteristics ratings_
...
processor and request-reply processing. Even though all communication in an eventdriven architecture is asynchronous, if multiple event processors share a single data‐
...
**208** **|** **Chapter 14: Event-Driven Architecture Style**


To illustrate this point, consider the example where one event processor sends a
...
cessors (also called _competing consumers_ ). As the request load increases, additional
...
Overall _simplicity_ and _testability_ rate relatively low with event-driven architecture,
...
**Architecture Characteristics Ratings** **|** **209**
...
Even if you can scale the database, what you eventually end up with is a triangleshaped topology, with the widest part of the triangle being the web servers (easiest to
...
_Figure 15-1. Scalability limits within a traditional web-based topology_


The _space-based_ architecture style is specifically designed to address problems involv‐
...
Space-based architecture gets its name from the concept of _[tuple space](https://oreil.ly/XVJ_D)_, the technique
...
**212** **|** **Chapter 15: Space-Based Architecture Style**


There are several architecture components that make up a space-based architecture: a
_processing unit_ containing the application code, _virtualized middleware_ used to man‐
age and coordinate the processing units, _data pumps_ to asynchronously send updated
data to the database, _data writers_ that perform the updates from the data pumps, and
_data readers_ that read database data and deliver it to processing units upon startup.
Figure 15-2 illustrates these primary architecture components.


_Figure 15-2. Space-based architecture basic topology_
...
ces). In addition to the application logic, the processing unit also contains an inmemory data grid and replication engine usually implemented through such
[products as Hazelcast, Apache Ignite, and Oracle Coherence.](https://hazelcast.com)


**General Topology** **|** **213**


_Figure 15-3. Processing unit_
...
components that make up the virtualized middleware include a _messaging grid_, _data_
_grid_, _processing grid_, and _deployment manager_ . These components, which are
described in detail in the next sections, can be custom written or purchased as thirdparty products.
...
**214** **|** **Chapter 15: Space-Based Architecture Style**


_Figure 15-4. Messaging grid_
...
**General Topology** **|** **215**


_Figure 15-5. Data grid_
...
**216** **|** **Chapter 15: Space-Based Architecture Style**
...
of a _member list_ . The member list contains the IP address and ports of all other pro‐
...
**218** **|** **Chapter 15: Space-Based Architecture Style**


_Figure 15-6. Processing grid_
...
A _data pump_ is a way of sending data to another processor which then updates data
...
**General Topology** **|** **219**


Data pumps are usually implemented using messaging, as shown in Figure 15-7. Mes‐
...
_Figure 15-7. Data pump used to send data to a database_
...
schema, an object, or even a _value-driven message_ (map message containing namevalue pairs). For updates, the data contained in the message of the data pump usually
...
**220** **|** **Chapter 15: Space-Based Architecture Style**
...
[(such as Ab Initio). The granularity of the data writers can vary based on the scope of](https://www.abinitio.com/en)
...
_Figure 15-8. Domain-based data writer_


**General Topology** **|** **221**


Alternatively, each class of processing unit can have its own dedicated data writer
...
_Figure 15-9. Dedicated data writers for each data pump_
...
**222** **|** **Chapter 15: Space-Based Architecture Style**


In the event where all instances come down (due to a system-wide crash or redeploy‐
...
_Figure 15-10. Data reader with reverse data pump_
...
The data writers and data readers essentially form what is usually known as a _data_
_abstraction layer_ (or _data access layer_ in some cases). The difference between the two
...
**General Topology** **|** **223**


only use the data readers and writers to indirectly access the database. A data abstrac‐
...
_data collision_ due to replication latency. A data collision occurs when data is updated
...
**224** **|** **Chapter 15: Space-Based Architecture Style**


_CollisionRate_ = _N_   - _[UR]_ [2]   - _RL_

_S_


where _N_ represents the number of service instances using the same named cache, _UR_
represents the update rate in milliseconds (squared), _S_ the cache size (in terms of
number of rows), and _RL_ the replication latency of the caching product.
...
The number of processing units containing the same named cache (as represented
through the _number of instances_ factor) also has a direct proportional relationship to
...
**226** **|** **Chapter 15: Space-Based Architecture Style**
...
architecture style. Transactional processing can occur on dynamic and elastic cloudbased environments while preserving physical data management, reporting, and data
analytics within secure and local on-prem environments.


_Figure 15-11. Hybrid cloud-based and on-prem topology_
...
_Figure 15-12. Replicated caching between processing units_
...
**228** **|** **Chapter 15: Space-Based Architecture Style**
...
_Figure 15-13. Distributed caching between processing units_
...
**Replicated Versus Distributed Caching** **|** **229**


_Table 15-1. Distributed versus replicated caching_
...
remember that in most cases _both_ models will be applicable within any given applica‐
...
A _near-cache_ is a type of caching hybrid model bridging in-memory data grids with a
distributed cache. In this model (illustrated in Figure 15-14) the distributed cache is
referred to as the _full backing cache_, and each in-memory data grid contained within
each processing unit is referred to as the _front cache_ . The front cache always contains
a smaller subset of the full backing cache, and it leverages an _eviction policy_ to remove
...
tively, a _random replacement_ eviction policy can be used in the front cache so that
...
**230** **|** **Chapter 15: Space-Based Architecture Style**


_Figure 15-14. Near-cache topology_
...
There are many challenges associated with this sort of system. First, there are only a
...
would be immediately recognized by the _deployment manager_, which in turn would
...
number of processing units shortly _before_ the tickets went on sale, therefore having
...
**232** **|** **Chapter 15: Space-Based Architecture Style**
...
_Figure 15-15. Space-based architecture characteristics ratings_
...
While high levels of elasticity, scalability, and performance are advantages in this
...
**234** **|** **Chapter 15: Space-Based Architecture Style**
...
enterprises in the late 1990s: merging with smaller companies, growing at a breakneck pace, and requiring more sophisticated IT to accommodate this growth. How‐
...
as much as possible. In fact, _reuse_ in all forms became the dominant philosophy in
...
_Figure 16-1. Topology of orchestration-driven service-oriented architecture_
...
The architect’s driving philosophy in this architecture centered around enterpriselevel reuse. Many large companies were annoyed at how much they had to continue
...
**236** **|** **Chapter 16: Orchestration-Driven Service-Oriented Architecture**


**Business Services**

_Business services_ sit at the top of this architecture and provide the entry point. For
...
The _enterprise services_ contain fine-grained, shared implementations. Typically, a
...
enterprise services. _Application services_ are one-off, single-implementation services.
...
_Infrastructure services_ supply the operational concerns, such as monitoring, logging,
...
The _orchestration engine_ forms the heart of this distributed architecture, stitching
...
While this approach might sound appealing, in practice it was mostly a disaster. Offloading transaction behavior to an orchestration tool sounded good, but finding the
...
**238** **|** **Chapter 16: Orchestration-Driven Service-Oriented Architecture**


_Figure 16-2. Message flow with service-oriented architecture_
...
_Figure 16-3. Seeking reuse opportunities in service-oriented architecture_


In Figure 16-3, an architect realizes that each of these divisions within an insurance
company all contain a notion of `Customer` . Therefore, the proper strategy for serviceoriented architecture entails extracting the customer parts into a reusable service and
allowing the original services to reference the canonical `Customer` service, shown in
Figure 16-4.


_Figure 16-4. Building canonical representations in service-oriented architecture_


**240** **|** **Chapter 16: Orchestration-Driven Service-Oriented Architecture**


In Figure 16-4, the architect has isolated all customer behavior into a single `Customer`
...
that the _disability insurance division_ cares nothing about. Yet, the team that deals with
...
monly work on tasks like “add a new address line to `CatalogCheckout` .” In a serviceoriented architecture, that could entail dozens of services in several different tiers,
...
Service-oriented architecture is perhaps the most technically partitioned generalpurpose architecture ever attempted! In fact, the backlash against the disadvantages
...
both monolithic _and_ distributed architectures.


_Figure 16-5. Ratings for service-oriented architecture_
...
**242** **|** **Chapter 16: Orchestration-Driven Service-Oriented Architecture**


This architecture did support some goals such as elasticity and scalability, despite the
...
**Architecture Characteristics Ratings** **|** **243**
...
_Microservices_ is an extremely popular architecture style that has gained significant
...
[larized by a famous blog entry by Martin Fowler and James Lewis entitled “Microser‐](https://oreil.ly/Px3Wk)
[vices,” published in March 2014. They recognized many common characteristics in](https://oreil.ly/Px3Wk)
...
cal design process for software projects. One concept in particular from DDD, _boun‐_
_ded context_, decidedly inspired microservices. The concept of bounded context
...
_Figure 17-1. The topology of the microservices architecture style_
...
**246** **|** **Chapter 17: Microservices Architecture**


orchestration-driven service-oriented architecture. Architects expect each service to
...
Microservices form a _distributed architecture_ : each service runs in its own process,
...
The driving philosophy of microservices is the notion of _bounded context_ : each ser‐
...
The term “microservice” is a _label_, not a _description_ .

—Martin Fowler

In other words, the originators of the term needed to call this new style _something_,
...
**248** **|** **Chapter 17: Microservices Architecture**
...
The _sidecar_ pattern offers a solution to this problem, illustrated in Figure 17-2.


_Figure 17-2. The sidecar pattern in microservices_
...
**250** **|** **Chapter 17: Microservices Architecture**


Once teams know that each service includes a common sidecar, they can build a _ser‐_
_vice mesh_, allowing unified control across the architecture for concerns like logging
...
_Figure 17-3. The service plane connects the sidecars in a service mesh_
...
**Operational Reuse** **|** **251**


The service mesh itself forms a console that allows developers holistic access to serv‐
ices, which is shown in Figure 17-4.


_Figure 17-4. The service mesh forms a holistic view of the operational aspect of microser‐_
_vices_
...
Architects use _service discovery_ as a way to build elasticity into microservices archi‐
...
**252** **|** **Chapter 17: Microservices Architecture**
...
_Figure 17-5. Microservices architecture with a monolithic user interface_
...
The second option for user interfaces uses _microfrontends_, shown in Figure 17-6.


_Figure 17-6. Microfrontend pattern in microservices_
...
[using a component-based web framework such as React or using one of several open](https://reactjs.org)
...
Fundamentally, architects must decide on _synchronous_ or _asynchronous_ communica‐
tion. Synchronous communication requires the caller to wait for a response from the
callee. Microservices architectures typically utilize _protocol-aware heterogeneous inter‐_
_operability_ . We’ll break down that term for you:


**254** **|** **Chapter 17: Microservices Architecture**
...
in a different technology stack. _Heterogeneous_ suggests that microservices fully
...
and mediator patterns manifest in microservices as _choreography_ and _orchestration_ .
...
_Choreography_ utilizes the same communication style as a broker event-driven archi‐
...
_Domain/architecture isomorphism_ is one key characteristic that architects should look
...
_Figure 17-7. Using choreography in microservices to manage coordination_


**256** **|** **Chapter 17: Microservices Architecture**


In Figure 17-7, the user requests details about a user’s wish list. Because the `Customer`
...
_Figure 17-8. Using orchestration in microservices_
...
The First Law of Software Architecture suggests that neither of these solutions is per‐
...
_Figure 17-9. Using choreography for a complex business process_
...
ties. This pattern is called the _front controller_ pattern, where a nominally choreo‐
...
**258** **|** **Chapter 17: Microservices Architecture**


Alternatively, an architect may choose to use orchestration for complex business pro‐
cesses, illustrated in Figure 17-10.


_Figure 17-10. Using orchestration for a complex business process_
...
tions across services is: _don’t!_ Fix the granularity components instead. Often,
...
**260** **|** **Chapter 17: Microservices Architecture**


A popular distributed transactional pattern in microservices is the _saga_ pattern, illus‐
trated in Figure 17-11.


_Figure 17-11. The saga pattern in microservices architecture_
...
In an error condition, the mediator must ensure that no part of the transaction suc‐
ceeds if one part fails. Consider the situation shown in Figure 17-12.


_Figure 17-12. Saga pattern compensating transactions for error conditions_
...
tion is called a _compensating transaction framework_ . Developers implement this
...
**262** **|** **Chapter 17: Microservices Architecture**


Another implementation of a compensating transaction framework has developers
build _do_ and _undo_ for each potentially transactional operation. This allows less coor‐
dination during transactions, but the _undo_ operations tend to be significantly more
complex than the _do_ operations, more than doubling the design, implementation, and
debugging work.
...
_Figure 17-13. Ratings for microservices_
...
**264** **|** **Chapter 17: Microservices Architecture**
...
about microservices in the following references:
 ...
 - _[Building Microservices](http://shop.oreilly.com/product/0636920033158.do)_ by Sam Newman (O’Reilly)

 - _[Microservices vs. Service-Oriented Architecture](https://learning.oreilly.com/library/view/microservices-vs-service-oriented/9781491975657)_ by Mark Richards (O’Reilly)

 - _[Microservices AntiPatterns and Pitfalls](https://learning.oreilly.com/library/view/microservices-antipatterns-and/9781492042716)_ by Mark Richards (O’Reilly)
...
an architecture style represents the culmination of analysis and thought about tradeoffs for architecture characteristics, domain considerations, strategic goals, and a host
of other things.
...
chaotic, making even the type of change impossible to predict. For example, a
few years ago, no one knew what _Kubernetes_ was, and now there are multiple
...
**268** **|** **Chapter 18: Choosing the Appropriate Architecture Style**
...
_Architecture characteristics that impact structure_
...
_Data architecture_
Architects and DBAs must collaborate on database, schema, and other datarelated concerns. We don’t cover much about data architecture in this book; it is
...
_Knowledge of process, teams, and operational concerns_
...
_Domain/architecture isomorphism_
...
operations, and space-based architecture, which offers a large number of discrete
processors.
...
_What communication styles between services—synchronous or asynchronous?_
...
**270** **|** **Chapter 18: Choosing the Appropriate Architecture Style**
...
This is a monolith with a single relational database, implemented with a single webbased user interface (with careful design considerations for mobile devices) to keep
...
_Figure 18-1. A modular monolith implementation of Silicon Sandwiches_
...
**272** **|** **Chapter 18: Choosing the Appropriate Architecture Style**


_Figure 18-2. A microkernel implementation of Silicon Sandwiches_
...
[The other unique design element here utilizes the Backends for Frontends (BFF) pat‐](https://oreil.ly/i3Hsc)
...
**Monolith Case Study: Silicon Sandwiches** **|** **273**


adaptor allows for the richest user interfaces and the ability to expand to support
...
**274** **|** **Chapter 18: Choosing the Appropriate Architecture Style**


An implementation of GGG using microservices is shown in Figure 18-3.


_Figure 18-3. A microservices implementation of Going, Going, Gone_
...
**Distributed Case Study: Going, Going, Gone** **|** **275**
...
**276** **|** **Chapter 18: Choosing the Appropriate Architecture Style**


In the final analysis, this design resolved to five quanta, identified in Figure 18-4.


_Figure 18-4. The quanta boundaries for GGG_
...
We don’t even suggest that it’s the best possible design, but it seems to have the _least_
_worst_ set of trade-offs. Choosing microservices, then intelligently using events and
...
**Distributed Case Study: Going, Going, Gone** **|** **277**
...
[Andrew Koenig defines an anti-pattern as something that seems like a good idea](https://oreil.ly/p9i_Y)
when you begin, but leads you into trouble. Another definition of an anti-pattern is a
repeatable process that produces negative results. The three major architecture antipatterns that can (and usually do) emerge when making architecture decisions are the
_Covering Your Assets_ anti-pattern, the _Groundhog Day_ anti-pattern, and the _Email-_
_Driven Architecture_ anti-pattern. These three anti-patterns usually follow a progres‐
...
There are two ways to overcome this anti-pattern. The first is to wait until the _last_
_responsible moment_ to make an important architecture decision. The last responsible
...
into the _Analysis Paralysis_ anti-pattern. The second way to avoid this anti-pattern is to
...
To illustrate this point, suppose an architect makes the decision that all productrelated reference data (product description, weight, and dimensions) be cached in all
...
made, so it keeps getting discussed over and over and over. The Groundhog Day antipattern gets it name from the Bill Murray movie _Groundhog Day_, where it was Febru‐
...
**282** **|** **Chapter 19: Architecture Decisions**
...
ture anti-pattern emerges: _Email-Driven Architecture_ . The Email-Driven Architecture
...
**Architecture Decision Anti-Patterns** **|** **283**


The second rule of effectively communicating architecture decisions is to only notify
...
[Michael Nygard, a well-known software architect and author of](https://www.michaelnygard.com) _Release It!_ (Pragmatic
Bookshelf), addressed the problem of what decisions an architect should be responsi‐
ble for (and hence what is an architecture decision) by coining the term _architectur‐_
_ally significant_ . According to Michael, architecturally significant decisions are those
decisions that affect the structure, nonfunctional characteristics, dependencies, inter‐
faces, or construction techniques.

The _structure_ refers to decisions that impact the patterns or styles of architecture
...
The _nonfunctional characteristics_ are the architecture characteristics (“-ilities”) that
...
_Dependencies_ refer to coupling points between components and/or services within
the system, which in turn impact overall scalability, modularity, agility, testability,
reliability, and so on.


**284** **|** **Chapter 19: Architecture Decisions**


_Interfaces_ refer to how services and components are accessed and orchestrated, usu‐
...
Finally, _construction techniques_ refer to decisions about platforms, frameworks, tools,
...
_Architecture Decision Records_ [(ADRs). ADRs were first evangelized by Michael](https://adr.github.io)
[Nygard in a blog post and later marked as “adopt” in the ThoughtWorks Technology](https://oreil.ly/yDcU2)
[Radar. An ADR consists of a short text file (usually one to two pages long) describing](https://oreil.ly/0nwHw)
a specific architecture decision. While ADRs can be written using plain text, they are
usually written in some sort of text document format like [AsciiDoc or](http://asciidoc.org) [Markdown.](https://www.markdownguide.org)
Alternatively, an ADR can also be written using a wiki page template.

Tooling is also available for managing ADRs. Nat Pryce, coauthor of _Growing Object-_
_Oriented Software Guided by Tests_ (Addison-Wesley), has written an open source tool
[for ADRs called ADR-tools. ADR-tools provides a command-line interface to manage](https://oreil.ly/6d8LN)
ADRs, including the numbering schemes, locations, and superseded logic. Micha
[Kops, a software engineer from Germany, has written a blog post about using ADR-](https://oreil.ly/OgBZK)
tools that provides some great examples on how they can be used to manage architec‐
ture decision records.

**Basic Structure**

The basic structure of an ADR consists of five main sections: _Title_, _Status_, _Context_,
_Decision_, and _Consequences_ . We usually add two additional sections as part of the
basic structure: _Compliance_ and _Notes_ . This basic structure (as illustrated in
...
add an _Alternatives_ section if necessary to provide an analysis of all the other possible
...
_Figure 19-1. Basic ADR structure_
...
The status of an ADR can be marked as _Proposed_, _Accepted_, or _Superseded_ . _Proposed_
...
_Accepted_ status means the decision has been approved and is ready for implementa‐
tion. A status of _Superseded_ means the decision has been changed and superseded by
...
**286** **|** **Chapter 19: Architecture Decisions**


The Superseded status is a powerful way of keeping a historical record of what deci‐
...
_ADR 42. Use of Asynchronous Messaging Between Order and Payment Services_

Status: Superseded by 68

_ADR 68. Use of REST Between Order and Payment Services_
...
_Request for Comments_ (or _RFC_ ) and specify a deadline date when that review would
...
_STATUS_
_Request For Comments, Deadline 09 JAN 2010_
...
**Architecture Decision Records** **|** **287**


decision. Level of effort costs can be estimated by multiplying the estimated number
of hours to implement the architecture decision by the company’s standard _Full-Time_
_Equivalency_ (FTE) rate. The project owner or project manager usually has the FTE
...
ices would read “ _we will use_ asynchronous messaging between services.” This is a
much better way of stating a decision as opposed to _“I think_ asynchronous messaging
...
**288** **|** **Chapter 19: Architecture Decisions**


Perhaps one of the most powerful aspects of the Decision section of ADRs is that it
allows an architect to place more emphasis on the _why_ rather than the _how_ . Under‐
...
[use Google’s Remote Procedure Call (gRPC) as a means to communicate between two](https://www.grpc.io)
...
**Architecture Decision Records** **|** **289**


picture of the context (and trade-offs) of the architecture decision and thus avoiding
these situations.
...
For example, consider the following architecture decision within a traditional ntiered layered architecture as illustrated in Figure 19-2. All shared objects used by
...
_Figure 19-2. An example of an architecture decision_


This architecture decision can be measured and governed automatically by using
[either ArchUnit in Java or NetArchTest in C#. For example, using ArchUnit in Java,](https://www.archunit.org)
the automated fitness function test might look as follows:


**290** **|** **Chapter 19: Architecture Decisions**
...
Even when storing ADRs in a version control system (such as Git), additional metainformation is useful beyond what the repository can support, so we recommend
...
**Architecture Decision Records** **|** **291**


For these reasons we recommend storing ADRs either in a wiki (using a wiki tem‐
...
_Figure 19-3. Example directory structure for storing ADRs_


The _application_ directory contains those architecture decisions that are specific to
some sort of application context. This directory is subdivided into further directories.
The _common_ subdirectory is for architecture decisions that apply to all applications,
such as “All framework-related classes will contain an annotation (@Framework in
Java) or attribute ([Framework] in C#) identifying the class as belonging to the
underlying framework code.” Subdirectories under the _application_ directory corre‐
...
applications). The _integration_ directory contains those ADRs that involve the com‐
munication between application, systems, or services. Enterprise architecture ADRs
are contained within the _enterprise_ directory, indicating that these are global architec‐
ture decisions impacting all systems and applications. An example of an enterprise
architecture ADR would be “All access to a system database will only be from the
...
**292** **|** **Chapter 19: Architecture Decisions**


The directory or landing page names indicated in this section are only a recommen‐
...
Simon Brown’s [C4 Model or The Open Group](https://c4model.com) [ArchiMate standard), no such stan‐](https://oreil.ly/gbNQG)
...
**Architecture Decision Records** **|** **293**
...
_Figure 19-4. Use of pub/sub between services_


**294** **|** **Chapter 19: Architecture Decisions**


The ADR for this architecture decision might look simliar to Figure 19-5:


_Figure 19-5. ADR 76. Asynchronous Pub/Sub Messaging Between Bidding Services_


**Architecture Decision Records** **|** **295**
...
risk assessments, and identifying risk through an activity called _risk storming_ .
##### **Risk Matrix**
...
_Figure 20-1. Matrix for determining architecture risk_
...
_risk assessment_ . A risk assessment is a summarized report of the overall risk of an
architecture with respect to some sort of contextual and meaningful assessment
criteria.


**298** **|** **Chapter 20: Analyzing Architecture Risk**


Risk assessments can vary greatly, but in general they contain the risk (qualified from
the risk matrix) of some _assessment criteria_ based on services or domain areas of an
...
_Figure 20-2. Example of a standard risk assessment_
...
to only show the high risk areas (shown in Figure 20-3), improving the overall signalto-noise ratio and presenting a clear picture of the state of the system (good or bad).


**Risk Assessments** **|** **299**


_Figure 20-3. Filtering the risk assessment to only high risk_
...
**300** **|** **Chapter 20: Analyzing Architecture Risk**


_Figure 20-4. Showing direction of risk with plus and minus signs_
...
_Figure 20-5. Showing direction of risk with arrows and numbers_


**Risk Assessments** **|** **301**


The direction of risk can be determined by using continuous measurements through
...
very few architects have full knowledge of every part of the system. This is where _risk_
_storming_ can help.
...
**302** **|** **Chapter 20: Analyzing Architecture Risk**


_Figure 20-6. Architecture diagram for risk storming example_
...
The _identification_ activity of risk storming involves each participant individually
...
storming dimension (area of risk being analyzed for that particular risk storming
...
The _consensus_ activity in the risk storming effort is highly collaborative with the goal
...
**304** **|** **Chapter 20: Analyzing Architecture Risk**


_Figure 20-7. Initial identification of risk areas_
...
Items 3 and 5 in the prior list do not need further discussion in this activity since all
...
**306** **|** **Chapter 20: Analyzing Architecture Risk**


This process continues until all participants agree on the risk areas identified. Once
...
_Figure 20-8. Consensus of risk areas_


**Mitigation**

Once all participants agree on the qualification of the risk areas of the architecture,
the final and most important activity occurs— _risk mitigation_ . Mitigating risk within
...
bined with breaking the single database into separate physical databases, would miti‐
...
**308** **|** **Chapter 20: Analyzing Architecture Risk**


 - Nurses can access patients’ medical records through a medical records exchange,
...
_Figure 20-9. High-level architecture for nurse diagnostics system example_
...
**Risk Storming Examples** **|** **309**


The architect has reviewed this architecture numerous times and believes it is ready
...
_Figure 20-10. Availability risk areas_
...
**310** **|** **Chapter 20: Analyzing Architecture Risk**


tion if the database were not available. To mitigate the database risk, participants
...
_Figure 20-11. Architecture modifications to address availability risk_


**Risk Storming Examples** **|** **311**
...
250 nurses (which provides an automatic governor for most of the services), the selfservice portion of the system can access the diagnostics engine as well as nurses, sig‐
...
between the API gateway and the diagnostics engine interface to provide a backpressure point if calls to the diagnostics engine get backed up. While this is a good
...
those requests would likely time out. Leveraging what is known as the [Ambulance](https://oreil.ly/ZfLU0)
[Pattern would give nurses a higher priority over self-service. Therefore two message](https://oreil.ly/ZfLU0)
...
there is a new service called the _Diagnostics Outbreak Cache Server_ that handles all
...
**312** **|** **Chapter 20: Analyzing Architecture Risk**


_Figure 20-12. Architecture modifications to address elasticity risk_
...
of the security checks for each API call, but still rated medium because all calls (selfservice, admin, and nurses) are going through the same API gateway. The architect,
...
**Risk Storming Examples** **|** **313**


The participants all agreed that having separate API gateways for each type of user
...
_Figure 20-13. Final architecture modifications to address security risk_
...
**314** **|** **Chapter 20: Analyzing Architecture Risk**
...
within the overall architecture, it confuses viewers. _Representational consistency_ is the
...
_Figure 21-1. Using representational consistency to indicate context in a larger diagram_
...
overly attached to what they have created, an anti-pattern we named the _Irrational_
_Artifact Attachment_ anti-pattern.


**316** **|** **Chapter 21: Diagramming and Presenting Architecture**
...
[advocate one over another (we quite happily used OmniGraffle for all the diagrams in](https://oreil.ly/fEoKR)
...
artifacts within an organization creates consistency within architecture diagrams
...
**318** **|** **Chapter 21: Diagramming and Presenting Architecture**
...
_Figure 21-2. Reproduction of microservices communication example showing different_
_services in unique colors_


**320** **|** **Chapter 21: Diagramming and Presenting Architecture**
...
Neal, one of the coauthors of this book, wrote a book several years ago entitled _[Pre‐](https://presentationpatterns.com)_
_[sentation Patterns](https://presentationpatterns.com)_ (Addison-Wesley Professional), about taking the patterns/antipatterns approach common in the software world and applying it to technical
presentations.

_Presentation Patterns_ makes an important observation about the fundamental differ‐
ence between creating a document versus a presentation to make a case for some‐
thing— _time_ . In a presentation, the presenter controls how quickly an idea is
...
tion and animations to hide the boundaries between slides. One common antipattern called out in _Presentation Patterns_ named [Cookie-Cutter states that ideas](https://oreil.ly/_Wldy)
...
The _Presentation Patterns_ [book calls out the Bullet-Riddled Corpse as a common anti-](https://oreil.ly/jS7DO)
...
_Figure 21-3. Bad version of a slide showing a negative anti-pattern_
...
**322** **|** **Chapter 21: Diagramming and Presenting Architecture**


_Figure 21-4. A better, incremental version that maintains suspense_
...
each individual reads them at their own pace. _Infodecks_ are slide decks that are not
...
_Invisibility_ is a simple pattern where the presenter inserts a blank black slide within a
...
**324** **|** **Chapter 21: Diagramming and Presenting Architecture**
...
_Figure 22-1. Boundary types created by a software architect_
...
There are three basic types of architect personalities: a _control freak architect_
(Figure 22-2), an _armchair architect_ (Figure 22-3), and an _effective architect_
...
**326** **|** **Chapter 22: Making Teams Effective**


**Control Freak**


_Figure 22-2. Control freak architect (iStockPhoto)_
...
**Architect Personalities** **|** **327**


For example, suppose an architect creates a component (building block of the archi‐
...
_implement_ this component is through a parallel loader pattern leveraging an internal
...
_Figure 22-3. Armchair architect (iStockPhoto)_
...
**328** **|** **Chapter 22: Making Teams Effective**


around, or simply move from project to project once the initial architecture diagrams
are completed.
...
_Figure 22-4. Trading system architecture created by an armchair architect_
...
**Architect Personalities** **|** **329**


opment teams need an architect’s support and guidance, and they need the architect
...
_Figure 22-5. Effective software architect (iStockPhoto)_
...
**330** **|** **Chapter 22: Making Teams Effective**


While this sounds obvious and easy, it is not. There is an art to becoming an effective
...
[given development team. This concept is known as Elastic Leadership and is widely](https://www.elasticleadership.com)
...
that arise, hence more control is needed on the team. Relatively simple projects
...
**332** **|** **Chapter 22: Making Teams Effective**


_Figure 22-6. Scale for the amount of control_
...
_Table 22-1. Scenario 1 example for amount of control_
...
**How Much Control?** **|** **333**


_Figure 22-7. Amount of control for scenario 1_
...
_Table 22-2. Scenario 2 example for amount of control_
...
**334** **|** **Chapter 22: Making Teams Effective**


_Figure 22-8. Amount of control for scenario 2_
...
_Process loss_ [, otherwise known as Brook’s law, was originally coined by Fred Brooks in](https://oreil.ly/rZt88)
his book _The Mythical Man Month_ (Addison-Wesley). The basic idea of process loss is
that the more people you add to a project, the more time the project will take. As
illustrated in Figure 22-9, the _group potential_ is defined by the collective efforts of
everyone on the team. However, with any team, the _actual productivity_ will always be
less than the group potential, the difference being the _process loss_ of the team.


**Team Warning Signs** **|** **335**


_Figure 22-9. Team size impacts actual productivity (Brook’s law)_
...
_Pluralistic ignorance_ also occurs as the team size gets too big. Pluralistic ignorance is
...
[“The Emperor’s New Clothes”, by Hans Christian Andersen. In the story, the king is](https://oreil.ly/ROvce)
...
**336** **|** **Chapter 22: Making Teams Effective**


that his new clothes are the best thing ever. This folly continues until a child finally
...
The third factor that indicates appropriate team size is called _diffusion of responsibil‐_
_ity_ . Diffusion of responsibility is based on the fact that as team size increases, it has a
...
_Figure 22-10. Diffusion of responsibility_
...
**Team Warning Signs** **|** **337**


An effective architect not only helps guide the development team through the imple‐
...
Dr. Atul Gawande wrote an excellent book called _[The Checklist Manifesto](https://oreil.ly/XNcV9)_ (Picador), in
...
**338** **|** **Chapter 22: Making Teams Effective**


Consider the checklist shown in Figure 22-11 for creating a new database table.


_Figure 22-11. Example of a bad checklist_
...
a checklist, invoking what is known as the _law of diminishing returns_ . The more
...
Three key checklists that we’ve found to be most effective are a _developer code comple‐_
_tion_ checklist, a _unit and functional testing_ checklist, and a _software release_ checklist.
Each checklist is discussed in the following sections.


**Leveraging Checklists** **|** **339**
...
team members read _The Checklist Manifesto_ by Atul Gawande to fully understand the
...
[When all else fails, architects can invoke what is known as the Hawthorne effect. The](https://oreil.ly/caGH_)
...
**340** **|** **Chapter 22: Making Teams Effective**


Figure 22-12 illustrates an example of a developer code completion checklist.


_Figure 22-12. Example of a developer code completion checklist_
...
to run code cleanup and formatting from the IDE? Plenty of times. In _The Checklist_
_Manifesto_, Gawande found this same phenomenon with respect to surgical proce‐
...
**342** **|** **Chapter 22: Making Teams Effective**


Anytime a build or deployment fails, the architect should analyze the root cause of
...
the use of what is typically called the _layered stack_ —the collection of third-party libra‐
...
One of your authors (Mark) was the lead architect on a particularly complex Javabased project with a large development team. One of the team members was particu‐
...
**344** **|** **Chapter 22: Making Teams Effective**


_Figure 22-13. Providing guidance for the layered stack_
...
**Providing Guidance** **|** **345**


can make the decision and does not need to consult the architect for that library.
...
**346** **|** **Chapter 22: Making Teams Effective**
...
**348** **|** **Chapter 23: Negotiation and Leadership Skills**


Gather as much information as possible _before_ entering into a
negotiation.
...
_Table 23-1. Nines of availability_

**Percentage uptime** **Downtime per year (per**
**day)**
...
**Negotiation and Facilitation** **|** **349**


involved) are certainly key factors in any negotiation but should be used as a last
...
The ancient Chinese warrior Sun Tzu wrote in _The Art of War_, “If his forces are uni‐
...
new trading system. However, does the _entire system_ need five nines of availability?
...
**350** **|** **Chapter 23: Negotiation and Leadership Skills**


Always remember that _demonstration defeats discussion_ .
...
This is a classic example of the _Ivory Tower_ architecture anti-pattern. Ivory tower
...
**Negotiation and Facilitation** **|** **351**
...
**Architect** : “Since change control is most important to us, we have formed a closedlayered architecture. This means all calls to the database need to come from the busi‐
ness layer.”
...
with is to have the developer arrive at the solution on their own. This creates a winwin situation where the architect cannot lose. For example, suppose an architect is
...
**352** **|** **Chapter 23: Negotiation and Leadership Skills**


insists that Framework Y would still be the better choice. Rather than argue the mat‐
...
milliseconds a day, or 31.5 seconds of downtime per year. This sort of complexity is
known as _essential complexity_ —in other words, “we have a hard problem.”
...
This sort of complexity is called _accidental complexity_ —in other words, “we have
...
_Figure 23-1. Introducing accidental complexity into a problem_


**354** **|** **Chapter 23: Negotiation and Leadership Skills**


An effective way of avoiding accidental complexity is what we call the _4 C’s_ of archi‐
tecture: _communication_, _collaboration,_ _clarity_, and _conciseness_ . These factors (illustra‐
ted in Figure 23-2) all work together to create an effective communicator and
collaborator on the team.


_Figure 23-2. The 4 C’s of architecture_
...
**The Software Architect as a Leader** **|** **355**
...
[with this through the use of a complex data mesh, which is a collection of distributed,](https://oreil.ly/6HmSp)
...
_Figure 23-3. Good architects find the balance between being pragmatic, yet visionary_
...
**356** **|** **Chapter 23: Negotiation and Leadership Skills**


fact, even if it is the database, could some of the data needed be cached so that the
...
people. The computer scientist [Gerald Weinberg is famous for saying, “No matter](https://oreil.ly/6fI2m)
what the problem is, it’s a people problem.” Most people think that solving technical
issues has nothing to do with people skills—it has to do with _technical knowledge_ .
...
responds with, “Well, _that’s_ a dumb idea.” Not only will that developer not make any
...
**The Software Architect as a Leader** **|** **357**
...
**358** **|** **Chapter 23: Negotiation and Leadership Skills**


quick, firm handshake. Knowing when to do a handshake and when not to is part of
...
notice that the architect is _telling_ the developer to do something they are simply too
...
**The Software Architect as a Leader** **|** **359**


rather than an impersonal professional demand. Second, notice the architect admits
...
**360** **|** **Chapter 23: Negotiation and Leadership Skills**


_Figure 23-4. A typical calendar of a software architect_
...
_Figure 23-5. Meeting types_


**Integrating with the Development Team** **|** **361**


_Imposed upon_ meetings are the hardest to control. Due to the number of stakeholders
...
**362** **|** **Chapter 23: Negotiation and Leadership Skills**


example, a developer might be working on a particularly difficult algorithm or piece
...
[tive leader, perhaps the best tip of all is from a quote from Theodore Roosevelt, the](https://oreil.ly/dCN_t)
26th US president:
...
One technique we use to maintain this balance is something we call the _20-minute_
_rule_ . The idea of this technique, as illustrated in Figure 24-1, is to devote _at least_ 20
...
resources to spend 20 minutes a day on, such as [InfoQ,](https://www.infoq.com) [DZone Refcardz, and the](https://dzone.com/refcardz)
[ThoughtWorks Technology Radar. Spend that minimum of 20 minutes to Google](https://www.thoughtworks.com/radar)
...
_Figure 24-1. The 20-minute rule_
...
**366** **|** **Chapter 24: Developing a Career Path**


first thing the architect does is to get that wonderful cup of coffee or tea. OK, in that
...
[was the Technology Radar. Over time, it gradually grew into the biannual Technology](https://www.thoughtworks.com/radar)
...
Neal also realized that this was the answer to a pervasive question at conference
...
**368** **|** **Chapter 24: Developing a Career Path**
...
_Figure 24-2. A sample ThoughtWorks Technology Radar_
...
**Developing a Personal Radar** **|** **369**


When using the radar for personal use, we suggest altering the meanings of the quad‐
...
_Assess_
Architects should use _assess_ for promising technologies that they have heard
...
_Trial_
The _trial_ ring indicates active research and development, such as an architect
...
_Adopt_
The _adopt_ ring represents the new things an architect is most excited about and
...
**370** **|** **Chapter 24: Developing a Career Path**


and, for busy architects, finding an excuse to carve out time in a busy schedule is the
...
of their radar? In Andrew McAfee’s book _Enterprise 2.0_ (Harvard Business Review
...
_Figure 24-3. Social circles of a person’s relationships_


In Figure 24-3, _strong links_ represent family members, coworkers, and other people
...
last week. _Weak links_ are casual acquaintances, distant relatives, and other people seen


**Using Social Media** **|** **371**


only a few times a year. Before social media, it was difficult to keep up with this circle
of people. Finally, _potential links_ represent people you haven’t met yet.
...
[architecture. To that end, check out the architecture katas on the companion website](https://oreil.ly/EPop7)
...
There are not right or wrong answers in architecture—only _trade-offs_ .
...
advice: always learn, always practice, and _go do some architecture_ !


**372** **|** **Chapter 24: Developing a Career Path**
...
3. What does _connascence of type_ mean? Is it static or dynamic connascence?
...
**374** **|** **Appendix: Self-Assessment Questions**
...
1. We define the term _component_ as a building block of an application—something
...
**376** **|** **Appendix: Self-Assessment Questions**
...
**378** **|** **Appendix: Self-Assessment Questions**
...
**380** **|** **Appendix: Self-Assessment Questions**


5. What are the two primary information channels a presenter has when giving a
presentation?
...
security risks of Diagnostics System API
gateway, 313
...
263-265
ratings in orchestration-driven serviceoriented architecture, 241
...
design versus architecture and tradeoffs, 74
...
reuse and, in orchestration-driven serviceoriented architecture, 241
Covering Your Assets anti-pattern, 282
Crap4J tool, 81
...
databases
ACID transactions in services of servicebased architecture, 168
...
rating in orchestration-driven serviceoriented architecture, 242
...
distributed vs. replicated caching in spacebased architecture, 227-230
...
broadcast capabilities, 203
choosing between request-based and eventbased model, 206
...
rating in orchestration-driven serviceoriented architecture, 243
rating in service-based architecture, 176
...
312
electronic devices recycling example (servicebased architecture), 172-173
Email-Driven Architecture anti-pattern, 283
...
shared library for entity objects in servicebased architecture, 170
...
plug-ins in microkernel architecture, 155
services in service-based architecture, 164
replaceability, 62
replication
replicated vs. distributed caching in spacebased architecture, 227-230
...
Service Info Capture filter, 146
